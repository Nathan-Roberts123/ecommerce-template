...
export default function ViewMoreTitle(props: ViewMoreTitleProps) {
    ...
    <div className={`section-wrapper w-full ${className ?? ""}`}>
      <div className="container-x mx-auto">
        <div className=" section-title mb-5 flex items-center justify-between">
          <div>
            <h1 className="font-600 text-xl leading-none text-qblacktext sm:text-3xl">
              {categoryTitle}
            </h1>
          </div>
          <div>
            <a href={seeMoreUrl}>
              <div className="flex items-center space-x-2">
                <p className="font-600 text-base text-qblack">View More</p>
